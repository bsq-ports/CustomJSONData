...
public:
  ...
  template <typename F> CustomBeatmapData* GetFilteredCopyOverride(F && filter) {
  ...
  template <class T> std::vector<T> GetBeatmapItemsCpp(GlobalNamespace::BeatmapDataItem::BeatmapDataItemType type) {
...
DECLARE_CLASS_CODEGEN(CustomJSONData, CustomBeatmapEventData, GlobalNamespace::BasicBeatmapEventData) {
  DECLARE_FASTER_CTOR(ctor, float time,
                      ::GlobalNamespace::BasicBeatmapEventType basicBeatmapEventType, int value, float floatValue);
...
DECLARE_CLASS_CODEGEN(CustomJSONData, CustomNoteData, GlobalNamespace::NoteData) {
  DECLARE_FASTER_CTOR(
      ctor, float time, float beat, int rotation, int lineIndex, ::GlobalNamespace::NoteLineLayer noteLineLayer,
...
DECLARE_CLASS_CODEGEN(CustomJSONData, CustomSliderData, GlobalNamespace::SliderData) {
  DECLARE_FASTER_CTOR(ctor, GlobalNamespace::SliderData::Type sliderType, ::GlobalNamespace::ColorType colorType,
                      bool hasHeadNote, float headTime, float headBeat, int headRotation, int headLineIndex,
                      ...
                      bool hasTailNote, float tailTime, int tailRotation, int tailLineIndex,
...
DECLARE_CLASS_CODEGEN(CustomJSONData, CustomWaypointData, GlobalNamespace::WaypointData) {
  DECLARE_FASTER_CTOR(ctor, float time, float beat, int rotation, int lineIndex,
                      ::GlobalNamespace::NoteLineLayer lineLayer, ::GlobalNamespace::OffsetDirection offsetDirection);
